...
const BentoTilt = ({ children, className = ''}) => {
    ...
    const handleMouseMove = (e) => {
        ...
        const tiltX = (relativeY - 0.5) * 2.5;
        const tiltY = (relativeX - 0.5) * -2.5;
...
export const BentoCard = ({ title, src, description }) => {
    return (
            ...
            <div className="container mx-auto px-3 md:px-10">
                <div className="px-5 py-32">
                    ...
                    <p className="max-w-md font-circular-web text-lg text-blue-50 opacity-50">
                        ...
                        products converge into an interconnected overlay experience of your world.
                    </p>
                </div>

                <BentoTilt className="border-hsla relative mb-7 h-96 w-full overflow-hidden rounded-md md:h-[65]">
                    <BentoCard
                        src="videos/feature-1.mp4"
                        title={<>radi<b>a</b>nt</>}
                        description="A cross-platform matagame app, turning your activities
                ...
                <div className="grid h-[135vh] grid-cols-2 grid-rows-3 gap-7">
                    <BentoTilt className="bento-tilt_1 row-span-1 md:col-span-1 md:row-span-2 ">
                        <BentoCard
                            ...
                            title={<>Zig<b>m</b>a</>}
                            description="A anime and gaming-inspired NFT collection - the IP primed for expansion."
                        />
                    </BentoTilt>
                    ...
                    <BentoTilt className="bento-tilt_1 row-span-1 ms-32 md:col-span-1 md:ms-0">
                        <BentoCard
                            ...
                            description="A gamified social hub, adding a new dimension of play to social
                             inrteracrion of web3 communities."
                        />
                    </BentoTilt>
                    ...
                    <BentoTilt className="bento-tilt_1 me-14 md:col-span-1 md:me-0">
                        <BentoCard
                            ...
                            title={<>Az<b>u</b>l</>}
                            description="A cross-woeld AI Agent - elevating your gamepplay to be more fun and productive."
                        />
                    </BentoTilt>
